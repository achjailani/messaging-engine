...
const { deleteMessage } = require("../app/controllers/chat/deleteMessage.js");
const { deletedThread } = require("../app/controllers/chat/deleteThread.js");
...
router.post("/messages/send/:userId", decode, chatValidation.sendValidator, send);
router.get("/messages", decode, list);
router.get("/messages/thread/:threadId", decode, thread);
router.post("/messages/reply/:threadId", chatValidation.sendValidator, decode, reply);
router.delete("/messages/delete/:messageId", decode, deleteMessage);
router.delete("/messages/thread/delete/:threadId", decode, deletedThread);
